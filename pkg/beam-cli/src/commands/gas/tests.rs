...
use crate::evm::{EvmFeeEstimate, TransactionGas};
...
fn render_gas_output_includes_fee_details() {
    ...
    assert_eq!(output.value["fee_mode"], "legacy");
    assert_eq!(output.value["gas_limit"], "21000");
    assert_eq!(output.value["gas_price"], "1000000000");
    assert_eq!(output.value["max_fee_per_gas"], "1000000000");
