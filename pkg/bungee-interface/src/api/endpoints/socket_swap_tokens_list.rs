...
/// Request headers for `GET /v3/swap/tokens/list`.
#[derive(Debug, Clone, Default, Serialize)]
pub struct Headers {}

/// Query parameters for `GET /v3/swap/tokens/list`.
...
/// Response body variants for `GET /v3/swap/tokens/list`.
#[derive(Debug, Clone)]
...
/// Wrapped Socket Swap v3 token-list response.
...
/// Token metadata entry as returned by the Socket Swap v3 API.
#[derive(Debug, Clone, Deserialize)]
pub struct TokenListToken {
    ...
    #[serde(rename = "isShortListed", default)]
    ...
    #[serde(rename = "balanceInUsd", default)]
